...
public class KategorijeAkt extends AppCompatActivity {
    ...
    static ArrayList<String> kategorije = new ArrayList<>();
    static ArrayList<String> autori = new ArrayList<>();

    public static ArrayList<String> getAutori() {
        return autori;
    }

    public static void setAutori(ArrayList<String> autori) {
